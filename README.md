...
Please set use_mlflow=True to leverage MLflow cability. Once training is done, User needs to run MLflow locally from their working directory. Run below command :
 mlflow ui
This will start MLflow UI on port 5000 (http://localhost:5000/) and user can manage/visulaize the end-to-end machine learning lifecycle.
